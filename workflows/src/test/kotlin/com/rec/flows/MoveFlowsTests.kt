...
class MoveFlowsTests {
    ...
    fun flowFailsWhenInitiatorIsMissingTransactionsTheyWereNotPartyTo() {
        ...
        val flow = Initiator(issuedTokens, listOf(createFrom(alice, dan, 30L)))
    ...
    fun signedTransactionReturnedByTheFlowIsSignedByTheHolder() {
        ...
        val flow = Initiator(issuedTokens, listOf(createFrom(alice, carly, 10L)))
    ...
    fun recordedTransactionHasASingleInputAndASingleOutput() {
        ...
        val expectedOutput: FungibleToken = createFrom(alice, carly, 10L)
    ...
    fun thereAreTwoRecordedStatesAfterMoveOnlyInRecipientDifferentIssuerIssuersKeepOldStates() {
        ...
        val expectedOutput1: FungibleToken = createFrom(alice, dan, 10L)
        val expectedOutput2: FungibleToken = createFrom(carly, dan, 20L)
